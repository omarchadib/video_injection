...
//         return;
//     }
//     std::string test_message = "lets make this work:   ";
//     ssize_t test_bytes_sent = send(socket, test_message.c_str(), test_message.size(), 0);

//     if (test_bytes_sent < 0) {
//         cerr << "Client: Error sending data." << endl;
//     } 
